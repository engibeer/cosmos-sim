...
c 
      ...
      parameter ( mcell    = 100 000 000  ) ! # of refinement cells  10000000 (keep <65M cells for CL6csf1)  
      parameter ( nrow     = 128        ) ! # of particles in 1d
      parameter ( nrowreal = 1024      ) ! # real NROW for MM simulations
      ...
      parameter ( nspec    = 5          ) ! # of particle species 1, 2, 3
...
c
      ...
      parameter ( npmax = 15 000 000 ) 
     

      integer nstarmax 
      parameter ( nstarmax = 3 000 000 )	
